        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('clients.update', $client->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="title-field" name="title" class="form-control" value="{{ $client->title }}"/>
                       @if($errors->has("title"))
                    ...
                    <input type="text" id="first_name-field" name="first_name" class="form-control" value="{{ $client->first_name }}"/>
                    ...
                    <input type="text" id="last_name-field" name="last_name" class="form-control" value="{{ $client->last_name }}"/>
                    ...
                    <input type="text" id="company_name-field" name="company_name" class="form-control" value="{{ $client->company_name }}"/>
                    ...
                    <input type="text" id="primary_mobile-field" name="primary_mobile" class="form-control" value="{{ $client->primary_mobile }}"/>
                    ...
                    <input type="text" id="secondary_mobile-field" name="secondary_mobile" class="form-control" value="{{ $client->secondary_mobile }}"/>
                    ...
                    <input type="text" id="primary_email-field" name="primary_email" class="form-control" value="{{ $client->primary_email }}"/>
                    ...
                    <input type="text" id="secondary_email-field" name="secondary_email" class="form-control" value="{{ $client->secondary_email }}"/>
